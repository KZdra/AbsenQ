...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        <div
            class="relative min-h-auto flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                ...
                <main>
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        <div id="docs-card"
                            ...
                            <div class="relative flex items-center gap-6 lg:items-start w-full">
                                <div id="docs-card-content" class="flex flex-col gap-4 w-full">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <svg class="size-5 sm:size-6" xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" fill="#FF2D20" version="1.1"
                                    id="Capa_1" viewBox="0 0 490 490" xml:space="preserve">
                                    <g>
                                        <g>
                                            <path
                                                d="M245,0C109.5,0,0,109.5,0,245s109.5,245,245,245s245-109.5,245-245S380.5,0,245,0z M245,449.3    c-112.6,0-204.3-91.7-204.3-204.3S132.4,40.7,245,40.7S449.3,132.4,449.3,245S357.6,449.3,245,449.3z" />
                                            <path
                                                d="M290.9,224.1h-25v-95.9c0-11.5-9.4-20.9-20.9-20.9s-20.9,9.4-20.9,20.9V245c0,11.5,9.4,20.9,20.9,20.9h45.9    c11.5,0,20.9-9.4,20.9-20.9S302.3,224.1,290.9,224.1z" />
                                        </g>
                                    </g>
                                </svg>
                            </div>
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">CLOCK :</h2>

                                <p class="mt-4 text-2xl/relaxed" id="time">
                        ...
                        <div
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">ABSEN TERBARU : </h2>

                                <p class="mt-4 text-2xl/relaxed" id="lastAbsen">
